          ...
          <div class="col-lg-8 offset-lg-2">
           ...
           <div class="row">
                ...
                <select class="form-control" name="district_id">
                 <option selected="" disabled="">Select One</option>
                  ...
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="Bangla" name="tag_bn" placeholder="Enter Tags Bangla">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Tags English</label>
                    <input type="text" class="form-control" id="English" name="tag_en" placeholder="Enter Tags English">
                  </div>
                </div>
               ...
               <div class="row">
                  ...
                  <div class="form-check col-md-6">
                    <input type="checkbox" class="form-check-input" id="exampleCheck2" name="first_section" value="1">
                    <label class="form-check-label" for="exampleCheck1">First Section</label>
                  </div>

                  <div class="form-check col-md-6">
                    <input type="checkbox" class="form-check-input" id="exampleCheck3" name="first_section_thumbnail" value="1">
                    <label class="form-check-label" for="exampleCheck1">First Section Thumbnail</label>
                  </div>
                     <div class="form-check col-md-6">
                    <input type="checkbox" class="form-check-input" id="exampleCheck4" name="bigthumbnail" value="1">
