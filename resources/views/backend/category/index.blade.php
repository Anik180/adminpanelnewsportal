                  ...
                  <div class="form-group">
                    <label >Category Name English</label>
                      @error('category_en')
                        ...
                        @enderror
                    <input type="text" name="category_en" class="form-control @error('category_en') is-invalid @enderror"  value="{{ old('category_en') }}" required id="English" placeholder="Enter Category Name English">
                  </div>
                  <div class="form-group">
